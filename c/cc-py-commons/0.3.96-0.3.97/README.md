# Comparing `tmp/cc_py_commons-0.3.96.tar.gz` & `tmp/cc_py_commons-0.3.97.tar.gz`
...
### Comparing `cc_py_commons-0.3.96/cc_py_commons/quotes/quote.py` & `cc_py_commons-0.3.97/cc_py_commons/quotes/quote.py`
