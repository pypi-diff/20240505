# Comparing `tmp/django_nets_core-0.1.77.tar.gz` & `tmp/django_nets_core-0.1.78.tar.gz`
...
### Comparing `django_nets_core-0.1.77/PKG-INFO` & `django_nets_core-0.1.78/PKG-INFO`
