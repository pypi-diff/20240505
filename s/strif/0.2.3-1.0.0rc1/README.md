# Comparing `tmp/strif-0.2.3.tar.gz` & `tmp/strif-1.0.0rc1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/strif-0.2.3.tar", last modified: Sun Jun 30 03:26:35 2019, max compression
+gzip compressed data, was "strif-1.0.0rc1.tar", last modified: Sat May  4 23:37:18 2024, max compression
```

## Comparing `strif-0.2.3.tar` & `strif-1.0.0rc1.tar`

### file list

```diff
@@ -1,11 +1,13 @@
-drwxr-xr-x   0 levy       (501) staff       (20)        0 2019-06-30 03:26:35.000000 strif-0.2.3/
--rw-r--r--   0 levy       (501) staff       (20)      892 2019-06-30 03:26:35.000000 strif-0.2.3/PKG-INFO
--rw-r--r--   0 levy       (501) staff       (20)     3453 2017-05-18 06:51:12.000000 strif-0.2.3/README.md
--rw-r--r--   0 levy       (501) staff       (20)       38 2019-06-30 03:26:35.000000 strif-0.2.3/setup.cfg
--rw-r--r--   0 levy       (501) staff       (20)      765 2017-09-24 17:15:22.000000 strif-0.2.3/setup.py
-drwxr-xr-x   0 levy       (501) staff       (20)        0 2019-06-30 03:26:35.000000 strif-0.2.3/strif.egg-info/
--rw-r--r--   0 levy       (501) staff       (20)      892 2019-06-30 03:26:35.000000 strif-0.2.3/strif.egg-info/PKG-INFO
--rw-r--r--   0 levy       (501) staff       (20)      143 2019-06-30 03:26:35.000000 strif-0.2.3/strif.egg-info/SOURCES.txt
--rw-r--r--   0 levy       (501) staff       (20)        1 2019-06-30 03:26:35.000000 strif-0.2.3/strif.egg-info/dependency_links.txt
--rw-r--r--   0 levy       (501) staff       (20)        6 2019-06-30 03:26:35.000000 strif-0.2.3/strif.egg-info/top_level.txt
--rw-r--r--   0 levy       (501) staff       (20)    12100 2019-06-30 03:26:07.000000 strif-0.2.3/strif.py
+drwxr-xr-x   0 levy       (502) staff       (20)        0 2024-05-04 23:37:18.105111 strif-1.0.0rc1/
+-rw-r--r--   0 levy       (502) staff       (20)    11358 2024-05-04 17:01:07.000000 strif-1.0.0rc1/LICENSE
+-rw-r--r--   0 levy       (502) staff       (20)     1101 2024-05-04 23:37:18.104903 strif-1.0.0rc1/PKG-INFO
+-rw-r--r--   0 levy       (502) staff       (20)     4925 2024-05-04 22:25:28.000000 strif-1.0.0rc1/README.md
+-rw-r--r--   0 levy       (502) staff       (20)      108 2024-05-04 17:20:03.000000 strif-1.0.0rc1/pyproject.toml
+-rw-r--r--   0 levy       (502) staff       (20)       38 2024-05-04 23:37:18.105168 strif-1.0.0rc1/setup.cfg
+-rw-r--r--   0 levy       (502) staff       (20)     1117 2024-05-04 22:14:59.000000 strif-1.0.0rc1/setup.py
+drwxr-xr-x   0 levy       (502) staff       (20)        0 2024-05-04 23:37:18.104682 strif-1.0.0rc1/strif.egg-info/
+-rw-r--r--   0 levy       (502) staff       (20)     1101 2024-05-04 23:37:18.000000 strif-1.0.0rc1/strif.egg-info/PKG-INFO
+-rw-r--r--   0 levy       (502) staff       (20)      166 2024-05-04 23:37:18.000000 strif-1.0.0rc1/strif.egg-info/SOURCES.txt
+-rw-r--r--   0 levy       (502) staff       (20)        1 2024-05-04 23:37:18.000000 strif-1.0.0rc1/strif.egg-info/dependency_links.txt
+-rw-r--r--   0 levy       (502) staff       (20)        6 2024-05-04 23:37:18.000000 strif-1.0.0rc1/strif.egg-info/top_level.txt
+-rw-r--r--   0 levy       (502) staff       (20)    14770 2024-05-04 22:35:24.000000 strif-1.0.0rc1/strif.py
```
...
### Comparing `strif-0.2.3/PKG-INFO` & `strif-1.0.0rc1/PKG-INFO`
...
### Comparing `strif-0.2.3/strif.egg-info/PKG-INFO` & `strif-1.0.0rc1/strif.egg-info/PKG-INFO`
...
### Comparing `strif-0.2.3/strif.py` & `strif-1.0.0rc1/strif.py`
