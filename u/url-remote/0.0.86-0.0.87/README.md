# Comparing `tmp/url_remote-0.0.86.tar.gz` & `tmp/url_remote-0.0.87.tar.gz`
...
## Comparing `url_remote-0.0.86.tar` & `url_remote-0.0.87.tar`
...
### Comparing `url_remote-0.0.86/README.md` & `url_remote-0.0.87/README.md`

 * *Files identical despite different names*

### Comparing `url_remote-0.0.86/setup.py` & `url_remote-0.0.87/setup.py`
...
### Comparing `url_remote-0.0.86/url_remote/src/action_name_enum.py` & `url_remote-0.0.87/url_remote/src/action_name_enum.py`

 * *Files identical despite different names*

### Comparing `url_remote-0.0.86/url_remote/src/component_name_enum.py` & `url_remote-0.0.87/url_remote/src/component_name_enum.py`

 * *Files identical despite different names*

### Comparing `url_remote-0.0.86/url_remote/src/url_circlez.py` & `url_remote-0.0.87/url_remote/src/url_circlez.py`
